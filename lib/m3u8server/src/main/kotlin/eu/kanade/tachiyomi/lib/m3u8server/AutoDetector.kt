...
class AutoDetector {
    ...
    companion object {
         ...
         */
        private fun isJpegHeader(data: ByteArray): Boolean = data.size >= 3 &&
         ...
         */
        private fun isPngHeader(data: ByteArray): Boolean = data.size >= 4 &&
            data[0] == PNG_HEADER[0] &&
            data[1] == PNG_HEADER[1] &&
            data[2] == PNG_HEADER[2] &&
            data[3] == PNG_HEADER[3]
         ...
         */
        private fun isGifHeader(data: ByteArray): Boolean = data.size >= 3 &&
            data[0] == GIF_HEADER[0] &&
            data[1] == GIF_HEADER[1] &&
            data[2] == GIF_HEADER[2]
