...
class M3u8ServerManager(
     ...
     */
    suspend fun processM3u8Url(m3u8Url: String, headers: Map<String, String> = emptyMap()): String? = server?.processM3u8Url(m3u8Url, headers)
     ...
     */
    fun registerProxy(url: String, headers: Map<String, String>): String? = server?.registerProxy(url, headers)
